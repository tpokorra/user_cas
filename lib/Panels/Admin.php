...
class Admin implements ISettings
{
    ...
    private $params = array('cas_server_version', 'cas_server_hostname', 'cas_server_port', 'cas_server_path', 'cas_force_login', 'cas_force_login_exceptions','cas_autocreate',
        ...
        'cas_import_map_uid', 'cas_import_map_displayname', 'cas_import_map_email', 'cas_import_map_groups', 'cas_import_map_groups_description', 'cas_import_map_groups_letter_filter', 'cas_import_map_quota', 'cas_import_map_enabled', 'cas_import_map_groups_letter_umlauts',
